...
line = Draft.make_line(App.Vector(-Rad1, 0., 0.), App.Vector(-10, 0., 0.))
line = Draft.make_line(App.Vector(10, 0., 0.), App.Vector(Rad1, 0., 0.))

y = -10.0
x = Rad1 + y

line = Draft.make_line(App.Vector(-x, y, 0.), App.Vector(x, y, 0.))

pl = App.Vector(-x+10.0,-7, 0.)  
rec = Draft.makeRectangle(3.0, 7.)  
Draft.move(rec, pl)
pl = App.Vector(x-10,-7, 0.) 
rec = Draft.makeRectangle(3.0, 7.)  
Draft.move(rec, pl)  
